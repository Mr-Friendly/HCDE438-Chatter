...
function useDB(room) {
  ...
  useEffect(async () => {
    const q = room
      ? query(collection(store, collection_name), where("room", "==", room), orderBy('time'))
      : query(collection(store, collection_name), orderBy('time'));
...
const firebaseConfig = {
  apiKey: "AIzaSyDoH25tRUqnCyS_fMYSv2oG8E5Q1eeiAQQ",
  authDomain: "chatter-e05ec.firebaseapp.com",
  projectId: "chatter-e05ec",
  storageBucket: "chatter-e05ec.appspot.com",
  messagingSenderId: "636988397375",
  appId: "1:636988397375:web:b4862903a72138238e658a"
};
